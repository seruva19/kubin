...
from train_modules.train_21.train_prior import (
        ...
        with gr.Column(scale=3):
            with gr.Accordion("General params", open=True) as general_params_ui:
                with gr.Row():
                    ...
                    clip_mean_std_path = gr.Textbox(
                        value=default_config_from_path["clip_mean_std_path"],
                        label="Clip mean standard path",
                        interactive=True,
                    )
            ...
            def update_config_from_ui(params):
                ...
                updated_config["clip_mean_std_path"] = params[clip_mean_std_path]
