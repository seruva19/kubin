...
def setup(kubin):
  source_image = gr.Image(type='pil', label="Image to upscale", elem_classes=['full-height'])
...
def upscale_with(kubin, upscaler, device, cache_dir, scale, output_dir, input_image, clear_before_upscale):
