...
(https://github.com/ai-forever/Kandinsky-3/blob/main/kandinsky3/model/diffusion.py)
"""
...
from models.model_31.kandinsky31.model.utils import get_tensor_items
...
class BaseDiffusion:
    ...
    def text_guidance(
        ...
        pred_large_noise = model(
            large_x, large_t * self.time_scale, large_context, large_context_mask.bool()
        )
    ...
    def p_mean_variance(
        ...
        pred_mean += torch.sqrt(1.0 - prev_alphas_cumprod - pred_var**2) * pred_noise
