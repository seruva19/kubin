...
(https://github.com/ai-forever/Kandinsky-3/blob/main/kandinsky3/model/unet.py)
"""
...
from models.model_31.kandinsky31.model.nn import (
    Identity,
    Attention,
    SinusoidalPosEmb,
    ConditionalGroupNorm,
)
from models.model_31.kandinsky31.model.utils import (
    exist,
    set_default_item,
    set_default_layer,
)
...
class DownSampleBlock(nn.Module):
    ...
    def forward(
        self, x, time_embed, context=None, context_mask=None, control_net_residual=None
    ):
...
class UNet(nn.Module):
    ...
    def forward(
        self, x, time, context=None, context_mask=None, control_net_residual=None
    ):
        time_embed = self.to_time_embed(time)
        if exist(context):
            time_embed = self.feature_pooling(time_embed, context, context_mask)
