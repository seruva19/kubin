...
(https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/kandinsky2_2/pipeline_kandinsky2_2_controlnet.py)
"""
...
class KandinskyV22ControlnetImg2ImgPipelinePatched(DiffusionPipeline):
    def __init__(
        self,
